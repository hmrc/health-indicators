...
import uk.gov.hmrc.healthindicators.models.{BobbyRuleActive, BobbyRuleIndicatorType, BobbyRulePending, DefaultReadme, IndicatorType, LeakDetectionResult, LeakDetectionViolation, NoReadme, ReadMeIndicatorType, ValidReadme}
...
class ScoreConfig {
  ...
  def scores(indicatorType: IndicatorType): Int = {
    indicatorType match {
      ...
      case i: LeakDetectionResult => i match {
